...
using NotificationApp.DataAccess.Providers;
using NotificationApp.Web.Hub;

namespace NotificationApp.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<DataProviderOptions>(Configuration.GetSection("DataProviderOptions"));
            
            
            //Register this for get client IP address
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseMvc(routes =>
            {
                routes.MapRoute(
                    name: "default",
                    template: "{controller=Notification}/{action=AdminView}/{id?}");
            });
        }
    }
}
